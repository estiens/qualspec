...
RSpec.describe "Qualspec RSpec Integration" do
  ...
  let(:mock_agent) do
    ->(prompt) {
      ...
      when /weather/i
        "I'd be happy to help with weather information! However, I don't have access to real-time weather data. You could check a weather service like weather.com or your phone's weather app for accurate forecasts."
      when /7.*8|8.*7/
        "7 times 8 equals 56."
      else
